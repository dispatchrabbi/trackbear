...
import type { TallyWithWorkAndTags } from 'src/lib/api/tally.ts';

import { formatCount } from 'src/lib/tally.ts';

const props = defineProps<{
  tallies: Array<TallyWithWorkAndTags>
}>();
...
const currentlyEditingTally = ref<TallyWithWorkAndTags>(null);
...
const currentlyDeletingTally = ref<TallyWithWorkAndTags>(null);
...
<template>
  ...
  >
    ...
    >
      <template #body="{ data }: { data: TallyWithWorkAndTags }">
