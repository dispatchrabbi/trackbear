...
const timeCountModel = reactive({
  hours: props.tally.measure === TALLY_MEASURE.TIME ? Math.floor(props.tally.count / 60) : null,
  minutes: props.tally.measure === TALLY_MEASURE.TIME ? (props.tally.count % 60) : null,
});
